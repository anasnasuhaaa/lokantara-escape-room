...
export const StageGrid: React.FC<StageGridProps> = ({ currentStage, onStageClick }) => {
  return (
    <div className="w-full h-screen flex flex-col items-center justify-center bg-linear-to-br from-black via-red-950 to-black">
      {/* Title */}
      <div className="mb-16 text-center">
        <h1
          className="text-6xl font-bold mb-4 tracking-widest text-red-500 glitch"
